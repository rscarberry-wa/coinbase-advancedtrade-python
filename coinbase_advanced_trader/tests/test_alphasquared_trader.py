...
class TestAlphaSquaredTrader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy_values_bth_agg_100 = {
    ...
    def test_get_strategy_recommendation_buy_bth1(self):
        self.mock_alphasquared_client.get_strategy_values.return_value = self.strategy_values_bth_agg_100

        recommendation = self.trader.get_strategy_recommendation('BTC-BTH', 'bth_agg_100', 55.0, None)

        self.mock_alphasquared_client.get_strategy_values.assert_called_once_with('bth_agg_100')
    ...
    def test_get_strategy_recommendation_buy_bth2(self):
        ...
        recommendation = self.trader.get_strategy_recommendation('BTC-BTH', 'bth_agg_100', 55.0,
                                                                 PastOrder(strategy_name='bth_agg_100',
    ...
    def test_get_strategy_recommendation_buy_bth3(self):
        ...
        recommendation = self.trader.get_strategy_recommendation('BTC-BTH', 'bth_agg_100', 61.0,
                                                                 PastOrder(strategy_name='bth_agg_100',
                                                                           timestamp=datetime.now() - timedelta(days=3),
                                                                           action='buy',
                                                                           order_id="32343",
    ...
    def test_get_strategy_recommendation_buy_bth5(self):
        ...
        recommendation = self.trader.get_strategy_recommendation('BTC-BTH', 'bth_agg_100', 65.0,
                                                                 PastOrder(strategy_name='bth_agg_100',
                                                                           timestamp=datetime.now() - timedelta(days=3),
                                                                           action='buy',
                                                                           order_id="32343",
    ...
    def test_get_strategy_recommendation_buy_bth6(self):
        ...
        recommendation = self.trader.get_strategy_recommendation('BTC-BTH', 'bth_agg_100', 45.0,
                                                                 PastOrder(strategy_name='bth_agg_100',
                                                                           timestamp=datetime.now() - timedelta(days=3),
                                                                           action='buy',
                                                                           order_id="32343",
    ...
    def test_get_strategy_recommendation_sell_bth1(self):
        ...
        recommendation = self.trader.get_strategy_recommendation('BTC', 'bth_agg_100', 82.0, None)
    ...
    def test_get_strategy_recommendation_sell_bth2(self):
        ...
        recommendation = self.trader.get_strategy_recommendation('BTC', 'bth_agg_100', 87.0,
                                                                 PastOrder(strategy_name='bth_agg_100',
    ...
    def test_get_strategy_recommendation_sell_bth3(self):
        ...
        recommendation = self.trader.get_strategy_recommendation('BTC', 'bth_agg_100', 91.0,
                                                                 PastOrder(strategy_name='bth_agg_100',
                                                                           timestamp=datetime.now() - timedelta(days=2),
                                                                           action='sell',
                                                                           order_id="32343",
    ...
    def test_execute_multiple_buys_and_sells_no_delays_between(self):
        ...
        for index, risk in enumerate(risks):
            ...
            if index in exoected_actions:
                assert recommendation is not None
                expected_action, expected_value, expected_nearest_risk = exoected_actions[index]
    ...
    def test_execute_multiple_buys_and_sells_high_delays_between(self):
        ...
        exoected_actions = {
            0: ('buy', Decimal('134'), 15.),
            1: ('buy', Decimal('134'), 20.),
            2: ('buy', Decimal('89'), 25.),
            3: ('buy', Decimal('134'), 20.),
            4: ('buy', Decimal('179'), 10.),
            5: ('buy', Decimal('134'), 20.),
            6: ('buy', Decimal('89'), 25.),
            7: ('buy', Decimal('89'), 30.),
            8: ('buy', Decimal('45'), 40.),
            9: ('buy', Decimal('45'), 40.),
            10: ('buy', Decimal('45'), 40.),
            11: ('sell', Decimal('0.1'), 60.),
            12: ('sell', Decimal('0.2'), 70.),
            14: ('sell', Decimal('0.3'), 80.),
            15: ('sell', Decimal('0.4'), 90.)
