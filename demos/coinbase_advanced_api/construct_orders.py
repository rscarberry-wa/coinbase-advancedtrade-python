from coinbase_advanced_trader.models import PastOrder
...
if __name__ == '__main__':
    ...
    past_orders = [
        PastOrder(strategy_name='eth_mod_100',
                  timestamp=datetime.strptime('2025-02-11T11:40:57.668433Z', format),
                  action='buy',
                  order_id='084ae298-9092-4cac-942d-49986f277376',
                  nearest_risk=Decimal(25.),
                  value=Decimal(89.),
                  balance=Decimal(0.),
                  status='filled'),
        PastOrder(strategy_name='bth_agg_100',
                  timestamp=datetime.strptime('2025-02-11T11:39:33.775826Z', format),
                  action='buy',
                  order_id='e5a0b394-b52f-4429-9486-3f97b98c8e04',
                  nearest_risk=Decimal(55.),
                  value=Decimal(89.),
                  balance=Decimal(0.),
                  status='filled')
    ]
